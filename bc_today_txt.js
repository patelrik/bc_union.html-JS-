...
/* calling function and store return values to eventHTML */ 
var eventHTML = getEvent(thisDay);
/* get element with id unionToday and inserting dateHTML and eventHTML before the end of the element's contents */
